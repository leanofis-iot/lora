...
// lr[] (4 bytes)
const uint8_t _dr               = 0;          // 1 byte
const uint8_t _port             = 1;          // 1 byte
const uint8_t _report           = 2;          // 2 bytes
// ch[] (12*29 = 348 bytes)
...
const uint8_t _in_max           = 9;          // 4 bytes
...
const uint8_t _coil_mask        = 12;         // 2 bytes
const uint8_t _relay_if         = 14;         // 2 bytes
const uint8_t _uplink           = 16;         // 1 bytes
// tm[] (2*3 = 6 bytes)
const uint8_t _no               = 0;          // 1 byte
const uint8_t _hour             = 1;          // 1 byte
const uint8_t _minute           = 2;          // 1 byte
const uint8_t _relay_tm         = 3;          // 2 bytes
// vl[] (12*5 = 60 bytes)
// const uint8_t _channel       = 0;          // 1 byte
