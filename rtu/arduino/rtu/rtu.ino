...
const uint8_t i_in_min          = 3;          // 4 bytes  input
const uint8_t i_in_max          = 7;          // 4 bytes  input
const uint8_t i_out_min         = 11;         // 4 bytes  input
const uint8_t i_out_max         = 15;         // 4 bytes  input
...
// dg[]
const uint8_t i_enable          = 0;          // 1 byte   checkbox
const uint8_t i_unit            = 3;          // 1 byte   select
...
const uint8_t i_unit            = 3;          // 1 byte   select
const uint8_t i_scale           = 4;          // 1 byte   checkbox
const uint8_t i_in_min          = 5;          // 4 bytes  input
const uint8_t i_in_max          = 9;          // 4 bytes  input
const uint8_t i_out_min         = 13;         // 4 bytes  input
const uint8_t i_out_max         = 17;         // 4 bytes  input
const uint8_t i_slave           = 21;         // 1 byte   input
const uint8_t i_function        = 22;         // 1 byte   select
const uint8_t i_register        = 23;         // 2 byte   input ??????????
const uint8_t i_type            = 25;         // 1 byte   select
const uint8_t i_quantity        = 26;         // 1 byte   input
const uint8_t i_decimal         = 27;         // 1 byte   input
const uint8_t i_coil_mask       = 28;         // 2 bytes  input
const uint8_t i_discrete_mask   = 30;         // 2 bytes  input
